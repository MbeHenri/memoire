\chapter{Algorithmes proposés et expérimentations}
...
\subsection{Méthode de type Bagging}
    ...
    Elle se déroule en plusieurs étapes suivantes qu'on peut retrouver sur la Figure \ref{fig:bio_bagging}:
   	 ...
   	 \subsubsection{Calcul des réseaux moléculaires}
		 ...
		 \subsubsection{Calcul des clusters contenus dans les réseaux moléculaires}
     ...
     \begin{figure}
   		 ...
   		 \end{center}
   		 \caption{Processus de l'approche de type Bagging}
   		 \label{fig:bio_bagging}
   	 \end{figure}
    
   	 \subsubsection{Transformation des spectres MS et RMN pour l'apprentissage multivues}
   	 ...
   	 \subsubsection{Construction des clusters en utilisant la complémentarité et le consensus entre les spectres MS et RMN des molécules}
   	 ...
   	 \subsubsection{Affectation des clusters aux réseaux moléculaires}
	...
	\subsection{Méthode de type Boosting}
...
\clearpage
   	 ...
   	 \begin{figure}
   		 ...
   		 \end{center}
   		 \caption{Processus de l'approche de type Boosting}
...
\subsection{Métriques d'évaluation}
 	...
 	Comme métrique de performances, nous avons utilisé l'exactitude, l'information mutuelle normalisé et la pureté:
	\begin{itemize}
